...
def scrap_prices():
    ...
    for url in set(urls):
        try:
            ...
            to_append = [fecha, product_plu, product_name, product_price, price_regular]
    ...
    path = f"/home/bjuanm/airflow/dags/files/{fecha_folder}"
    path_exists = os.path.exists(path)

    if not path_exists:
        os.makedirs(path)
    df_historia.to_csv(f"/home/bjuanm/airflow/dags/files/{fecha_folder}/precios_coto_{fecha_file}.csv", index = False)
    df_historia.to_csv("/home/bjuanm/airflow/dags/files/precios_coto.csv", index = False)