...
def scrap_prices():
    ...
    if not path_exists:
        os.makedirs(path)
    df_historia.to_csv(f"/home/bjuanm/airflow/dags/files/{fecha_folder}/precios_coto_{fecha_file}_test.csv", index = False)
    df_historia.to_csv("/home/bjuanm/airflow/dags/files/precios_coto_test.csv", index = False)